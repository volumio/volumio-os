...
BOOT_START=20
BOOT_END=148
IMAGE_END=4436           # BOOT_END + 4288 MiB (/img squashfs)
...
write_device_bootloader() {
  # TODO: bootloader currently has to be installed manually on boot0/boot1
  # eMMC hardware partitions and cannot be shipped along the Volumio image.
